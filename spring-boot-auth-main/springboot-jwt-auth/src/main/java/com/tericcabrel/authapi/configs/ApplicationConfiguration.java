...
public class ApplicationConfiguration {
    ...
    public ModelMapper getModelMapper() {
        ...
        //modelMapper.createTypeMap(ShoppingCart.class, ShoppingCartDto.class).addMapping(ShoppingCart::getShoppingCartProducts, ShoppingCartDto::setShoppingCartProducts);
